...
/**
 * This class is used to represent a participant (of a meeting) with an email and a meetingId.
 */
...
/**
 * Constructor for creating a new Participant object with an email and a meetingId.
 * @param email
 * @param meetingId
 */
